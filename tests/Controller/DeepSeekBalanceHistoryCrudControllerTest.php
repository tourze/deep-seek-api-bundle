 ...
 * @internal
 */
#[CoversClass(DeepSeekBalanceHistoryCrudController::class)]
#[RunTestsInSeparateProcesses]
final class DeepSeekBalanceHistoryCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    private function getController(): DeepSeekBalanceHistoryCrudController
    {
        return new DeepSeekBalanceHistoryCrudController();
    }

    protected function getControllerService(): DeepSeekBalanceHistoryCrudController
    {
        return self::getService(DeepSeekBalanceHistoryCrudController::class);
    }
